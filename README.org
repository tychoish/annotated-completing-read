#+TITLE: annotated-completing-read -- ergonomic completing-read with annotations
...
lot with =consult--read=, but it's lightweight and is part of a public API. And
of course, and works well with [[https://github.com/minad/vertico][vertico]] (and other minibuffer completion
